...
from trainer_msra import train_one_epoch, evaluate, load_data, create_criterion, create_optimizer_and_scheduler, final_test
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='P4T_MSRA/2', help='Path to the YAML config file')
