...
class BAD(Dataset):
    def __init__(self, roots, split_files, frames_per_clip=16, frame_interval=1, max_frame_interval=20, num_points=2048, train=True, aug=[]):
        ...
        for root, split_file in zip(roots, split_files):
    ...
    def __getitem__(self, idx):
        ...
        clip = clip / 300
        _ = ""
        return clip.astype(np.float32), label, index, _
